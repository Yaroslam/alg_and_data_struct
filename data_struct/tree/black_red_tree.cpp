...
void RBtree::insertfix(node_rb *new_node)
{
     node_rb* help_node;
     if(root == new_node)
     {
...
void RBtree::delfix(node_rb *to_del)
{
    node_rb *help_node;
...
void RBtree::leftrotate(node_rb *node)
{
     if(node->right == NULL)
           return ;
     else
...
void RBtree::rightrotate(node_rb *node)
{
     if(node->left == NULL)
          return ;
     else
...
node_rb* RBtree::successor(node_rb *p)
{
      node_rb *help_node=NULL;
     if(p->left!=NULL)
     {
